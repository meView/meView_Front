  ...
  return (
    <QuestionWrapper>
      <Top>
        ...
        <QuestionText text={"어떤 리뷰를 듣고 싶으신가요?"} text2={"원하는 리뷰항목을 선택해주세요!"}/>
        <div className="answer">
          <div className={`${checkedStrength} answer-box1`} onClick={()=>{
            handleAnswer(1);
          }}>
            <div className="answer-text">
              <p className="answer-title">내 강점이 궁금해요</p>
            </div>
            <img className="radio-button" alt="checked radio" src={`/image/${checkedStrength}-radio.svg`}/>
          </div>
          <div className={`${checkedWeakness} answer-box2`} onClick={()=>{
            handleAnswer(2);
          }}> 
            <div className="answer-text">
              <p className="answer-title">내 약점이 궁금해요</p>
            </div>
            <img className="radio-button" alt="unchecked radio" src={`/image/${checkedWeakness}-radio.svg`}/>
          </div>
          <div className={`${checkedBoth} answer-box2`} onClick={()=>{
            handleAnswer(3);
          }}> 
            <div className="answer-text">
              <p className="answer-title">둘 다 궁금해요</p>
            </div>
            <img className="radio-button" alt="unchecked radio" src={`/image/${checkedBoth}-radio.svg`}/>
          </div>
        </div>
      </Top>
      <Bottom>
